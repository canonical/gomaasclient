...
func (s *SSLKeys) client() *APIClient {
	return s.APIClient.SubClient("account/prefs/sslkeys")
}

// Get fetches a list of SSLKey objects
func (s *SSLKeys) Get(ctx context.Context) ([]entity.SSLKey, error) {
...
func (s *SSLKeys) Create(ctx context.Context, key string) (*entity.SSLKey, error) {
